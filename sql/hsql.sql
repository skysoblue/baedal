...
DROP TABLE MENU;
DROP TABLE STO_MENU CASCADE;

SELECT * FROM MEMBER;
SELECT * FROM CATEGORY;
SELECT * FROM STORE;
SELECT * FROM MENU;
SELECT * FROM STO_MENU;
...
INSERT INTO MENU VALUES('ddokbokki', '떡볶이', 'menu_ddokbokki.png'); 
INSERT INTO MENU VALUES('karbonara', '카르보나', 'menu_karbonara.png'); 
INSERT INTO MENU VALUES('soondae', '순대', 'menu_soondae.png'); 
INSERT INTO MENU VALUES('dongas', '돈까스', 'menu_dongas.png'); 
INSERT INTO MENU VALUES('kimchibok', '김치볶음밥', 'menu_kimchibok.png'); 
INSERT INTO MENU VALUES('dakbal', '닭발', 'menu_dakbal.png'); 
INSERT INTO MENU VALUES('kimbab', '김밥', 'menu_kimbab.png'); 
INSERT INTO MENU VALUES('ramen', '라면', 'menu_ramen.png'); 
-----------------------------------------
-- 메뉴 및 가격 테이블(4페이지)
CREATE TABLE STO_MENU(
	STORE_MENU_SEQ INT GENERATED BY DEFAULT AS SEQUENCE SEQ,-- 가게별 메뉴 시퀀스 (PK)
	STORE_ID VARCHAR(30),-- 가게 ID (FK)
	MENU_ID VARCHAR(30),-- 메뉴 ID (FK)
	PRICE INT,-- 가격 
	CONSTRAINT STORE_MENU2_PK PRIMARY KEY(STORE_MENU_SEQ),
	CONSTRAINT STORE_MENU2_FK_STORE FOREIGN KEY(STORE_ID)
		REFERENCES STORE(STORE_ID),
	CONSTRAINT STORE_MENU2_FK_MENU FOREIGN KEY(MENU_ID)
		REFERENCES MENU(MENU_ID)
);
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','ddokbokki',5000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','karbonara',10000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','soondae',4000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','dongas',6000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','kimchibok',7000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','dakbal',8000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','kimbab',2000)
INSERT INTO STO_MENU VALUES(NEXT VALUE FOR SEQ, 'store_rice','ramen',3000)
